...
export const CallToActionFooter = () => {
  ...
  return (
    <footer className="relative overflow-hidden" style={{ background: '#101820' }}>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span style={{ color: 'rgba(255, 255, 255, 0.7)' }}>+91 XXXXX XXXXX</span>
                </li>
                <li className="flex items-center gap-3">
      ...
      {/* WhatsApp Button */}
      <a href="https://wa.me/91XXXXXXXXXX" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 animate-bounce-subtle" style={{ background: '#25D366', boxShadow: '0 4px 20px rgba(37, 211, 102, 0.4)' }}>
